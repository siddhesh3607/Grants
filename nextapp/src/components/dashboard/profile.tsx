...
export default function Profile() {
    ...
    return <div>
        <div className="flex flex-col gap-5 ">
            <span className="text-xl cursor-pointer"><strong>Profile Address: </strong>{account.address}</span>
            <span className="text-xl"><strong>Balance:</strong> <span className="">{accData?.formatted} {accData?.symbol} {accData && accData?.decimals > 0 ? "🤑" : "(go for some bounty I guess)"}</span></span>
