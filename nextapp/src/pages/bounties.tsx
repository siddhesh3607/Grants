    ...
    return <Page background noLoading>
        <div className="w-full flex" >
            ...
            {screen!.width > 640 ?
                <>
                    {selectedBounty &&
                        <div className="w-[75%] flex flex-col gap-5 ml-7 rounded-2xl bg-white/50 p-3 px-4 h-[70vh]" style={{border:'solid'}} >
                            {/* DESKTOP VIEW */}
                            ...
                            <div className="text-black">{selectedBounty.description}</div>
                            <div className="flex w-full justify-evenly">
                                <Link href={selectedBounty.url} target="_blank" className="btn  rounded-lg">Checkout<FaExternalLinkAlt size={15} className="mb-1" /></Link>
                                <Link href={selectedBounty.url} target="_blank" className="btn  rounded-lg">Fork Repo<FaExternalLinkAlt size={15} className="mb-1" /></Link>
                                <Link href={selectedBounty.url} target="_blank" className="btn  rounded-lg">Submit Solution<FaExternalLinkAlt size={15} className="mb-1" /></Link>
